Namespace DashboardItemRuntimeExample
	Partial Public Class ViewerForm1
		...
		Private Sub InitializeComponent()
			...
			' dashboardViewer
			' 
			Me.dashboardViewer.DashboardSource = GetType(DashboardItemRuntimeExample.SampleDashboard)
...
'ORIGINAL LINE: this.dashboardViewer.CustomizeDashboardTitle += new DevExpress.DashboardWin.CustomizeDashboardTitleEventHandler(this.DashboardViewer_CustomizeDashboardTitle);
			' 
			' ViewerForm1
			' 
